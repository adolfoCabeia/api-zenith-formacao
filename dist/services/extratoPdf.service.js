            ...
            if (alunos.length === 0) {
                ...
                alunos.forEach((aluno, i) => {
                    const turmaInfo = aluno.turma
                        ...
                        : 'Sem turma';
                    doc.text(`${i + 1}. ${aluno.nome} | ${aluno.email} | Turma: ${turmaInfo}`);
                });
            }
        }
            ...
            if (pagamentos.length === 0) {
                ...
                pagamentos.forEach((pag, i) => {
                    const valorFormatado = typeof pag.valor === 'number'
                        ...
                        : pag.valor;
                    doc.text(`${i + 1}. ${pag.aluno.nome} | Valor: ${valorFormatado} | Status: ${pag.status}`);
                });
            }
        }
        doc.end();
...
//# sourceMappingURL=extratoPdf.service.js.map